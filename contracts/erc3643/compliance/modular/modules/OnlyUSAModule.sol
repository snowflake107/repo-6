...
contract OnlyUsaModule is AbstractModule {
    ...
    function moduleCheck(
        ...
        return isCountryAllowed(receiverCountry);
    }
     ...
     */
    function isCountryAllowed(uint16 _country) public pure returns (bool) {
        return _country == 840; // 840 is the USA code in the ISO_3166
    }
