...
contract TransferLimitOneHundredModule is AbstractModule {
    ...
    function moduleTransferAction(address _from, address _to, uint256 _value) external override onlyComplianceCall {
        ...
        uint256 oneHundredTokens = 100 * 10 ** token.decimals();
        require(_value <= oneHundredTokens, "Transfer amount must be one hundred or less");
    }
    ...
    function name() public pure returns (string memory _name) {
        return "TransferLimitOneHundredModule";
    }
}
