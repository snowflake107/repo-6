...
import { HTSNonFungibleToken } from './HTSNonFungibleToken.sol';
 ...
 */
abstract contract DLTEnumerableWithHTS is DLT, IDLTEnumerable, HTSNonFungibleToken {
    ...
    function _mintMain(address recipient, uint256 amount) internal virtual {
        require(recipient != address(0), "Invalid Recipient");
        require(amount > 0, "Invalid Amount");

        int64 mainId = _mintHTSToken(recipient);
        int64 subid = 1;
    ...
    function _mint(
        ...
        require(_isTokenMinted(mainId), "Token Not Minted");
