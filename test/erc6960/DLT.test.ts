...
import { DLTNonReceiver, DLTReceiver, DLTReceiverRevertable, TestDLT } from "../../typechain-types";
import { Signer } from "ethers";

describe("DLT", async function () {
  let DLT: TestDLT;
  let DLTReceiver: DLTReceiver;
  let DLTNonReceiver: DLTNonReceiver;
  let DLTReceiverRevertable: DLTReceiverRevertable;
  let owner: Signer;
  let user1: Signer;
